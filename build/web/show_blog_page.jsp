<%-- 
    ...
    Created on : 10 Apr, 2024, 9:05:01 PM
    Author     : Sujeet's PC
--%>
...
<html>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v19.0" nonce="EhiHgYJe"></script>
</head>
<body>
        ...
        <div class="row mt-4 my-3">
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header text-white" id="primary-background1">
                    ...
                    <div class="card-body">
                        ...
                        <img class="card-img-top my-2" src="blogs_pics/<%=p.getpPic()%>" alt="image not found" class="img-fluid">
                        ...
                        <div class="row my-3 row-user">
                            ...
                            <div class="col-md-4">
                                <p class="post-date"><%=p.getpDate().toLocaleString().toString()%></p> 
                            </div>
                        </div>
                ...
                <div class="card-footer" id="primary-background1">
                    ...
                    <a href="profile.jsp" class="btn btn-outline-light btn-sm"><span>Go to profile page</span></a> 
                </div>
